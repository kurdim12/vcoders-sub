    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">UNI-Agent</h1>
          <p className="text-muted-foreground mt-2">Your AI academic companion</p>
        </div>
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent>
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <Button type="submit" className="w-full" size="lg" disabled={loading || !storeReady}>
        ...
        <div className="mt-4 p-4 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
          <p className="text-xs text-blue-800 dark:text-blue-200 text-center">
            <strong>Demo Mode:</strong> Use any email/password to sign in. No real authentication required.
          </p>
        </div>
      </div>
    </div>
